...
//引入jsonwebtoken模块，方便生成token
var jwt = require('jsonwebtoken');
//引入自己写的config文件， 里面 只有一个config对象
var config = require('./config');
//引入自定义的user对象， 里面定义了model， model里面定义了
var User = require('./app/models/user');
//得到环境变量里面设置的端口，如果没有则使用默认的8080端口
...
apiRoutes.use(function(req, res, next) {
  console.log('中间件被访问');
  //得到post中的token， 没有则获取get中的token， 再没有则得到headers中的x-access-token
